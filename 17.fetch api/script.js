function getUser() {
    fetch("https://randomuser.me/api/?results=3")
        ...
        .then((data) => {
            // document.querySelector(".user").innerHTML=""   aadhura code h y line error fix nhi hua
            data.results.forEach(function (user) {
                ...
                badge.className =
                    "inline-block mt-2 px-3 py-1 bg-blue-900 text-blue-200 text-xs rounded-full";
